...
"""Implementation for MqttToRosNodeTurtlebot4"""
import json
import socket
import time
...
class MqttToRosNodeTurtlebot4(Node):
    """
    ...
    def __init__(self, name='mqtt_to_ros_bridge_node'):
        """Construct the MqttToRosNodeTurtlebot4."""
        super().__init__(name)
...
def main(args=None):
    """Execute the MqttToRosNodeTurtlebot4."""
    rclpy.init(args=args)
    node = MqttToRosNodeTurtlebot4('mqtt_to_ros_bridge_node')
    try:
        rclpy.spin(node)
