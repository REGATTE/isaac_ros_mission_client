...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument('ros_to_mqtt_name', default_value='RosToMqttBridgeTurtlebot4',
        ...
        DeclareLaunchArgument('mqtt_to_ros_name', default_value='MqttToRosBridgeTurtlebot4',
